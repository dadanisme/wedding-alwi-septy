...
export function IconUserPlus({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function IconWhatsApp({ size = 18, className = '', ...props }: IconProps) {
  return (
    <svg
      ...
      {...props}
    >
      <path d="M12.04 2c-5.46 0-9.91 4.45-9.91 9.91 0 1.75.46 3.45 1.32 4.95L2.05 22l5.25-1.38c1.45.79 3.08 1.21 4.74 1.21 5.46 0 9.91-4.45 9.91-9.91 0-2.65-1.03-5.14-2.9-7.01A9.82 9.82 0 0 0 12.04 2zm5.78 14.16c-.24.68-1.39 1.3-1.92 1.38-.5.08-1.14.11-3.66-.93-2.69-1.11-4.41-3.84-4.54-4.01-.13-.18-1.08-1.44-1.08-2.75 0-1.31.69-1.96.93-2.22.24-.26.54-.33.72-.33.18 0 .36 0 .52.01.17.01.4.06.62.54.24.52.81 1.98.88 2.12.07.15.12.32.02.52-.1.2-.15.32-.3.49-.15.17-.32.39-.45.52-.15.15-.31.31-.13.62.18.31.8 1.32 1.72 2.14 1.18 1.05 2.17 1.38 2.48 1.53.31.15.49.13.67-.08.18-.21.78-.91.99-1.22.21-.31.42-.26.7-.15.28.1.78.37 1.33.64.55.28.92.42 1.06.63.14.22.14 1.25-.1 1.93z" />
    </svg>
  );
}
