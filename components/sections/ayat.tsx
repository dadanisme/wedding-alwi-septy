...
export function Ayat() {
  return (
    <section id="ayat" className="relative overflow-hidden bg-cream scroll-mt-0">
      ...
      <svg
        className="absolute top-[44px] left-[-14px] h-[118px] w-[118px] opacity-50 lg:hidden"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
      <svg
        className="absolute right-[-14px] bottom-[24px] h-[118px] w-[118px] rotate-180 opacity-50 lg:hidden"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
      ...
      <svg
        className="absolute top-[70px] left-[6px] hidden h-[200px] w-[200px] opacity-50 lg:block"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
      <svg
        className="absolute top-[70px] right-[6px] hidden h-[200px] w-[200px] -scale-x-100 opacity-50 lg:block"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
      <svg
        className="absolute bottom-[20px] left-[60px] hidden h-[150px] w-[150px] -scale-y-100 opacity-[0.32] lg:block"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
      <svg
        className="absolute right-[60px] bottom-[20px] hidden h-[150px] w-[150px] -scale-100 opacity-[0.32] lg:block"
        aria-hidden="true"
      >
        <use href="#sulur" />
      </svg>
